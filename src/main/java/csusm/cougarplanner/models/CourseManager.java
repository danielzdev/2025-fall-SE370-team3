...
public class CourseManager {
     ...
     */
    public List<List<Assignment>> separateAssignmentsByCourse(List<Assignment> assignments) {
     ...
     */
    public Assignment[] convertListToAssignmentArray(List<Assignment> assignments) {
